...
REM start powershell -Command "Get-Content %APPDATA%\parsec\parsec-core.log -Wait"
cd core
parsec.exe core gui --log-level=INFO --log-file "%APPDATA%"\parsec\parsec-core.log
